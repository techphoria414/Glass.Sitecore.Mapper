...
namespace Glass.Sitecore.Mapper.Tests.Data
{
    ...
    public class SitecoreFieldDecimalHandlerFixture
    {
        ...
        [Test]
        public void GetFieldValue_ValidDecimal_ReturnsValue_RegardlessOfCulture([Values("en-GB", "en-US", "de-DE", "da-DK", "fr-FR")]string culture)
        {
            //Assign
            ...
            try
            {
                Assert.That(result, Is.EqualTo(10000.11M));
            }
            finally
            {
        ...
        [Test]
        [ExpectedException(typeof(MapperException))]           
        public void SetFieldValue_NonDecimal_ThrowsException()
        {
            //Assign
            object value = null;
