...
namespace Glass.Sitecore.Mapper.Tests.Data
{
    ...
    public class SitecoreFieldFloatHandlerFixture
    {
        ...
        [Test]
        public void GetFieldValue_ValidFloat_ReturnsValue_RegardlessOfCulture([Values("en-GB", "en-US", "de-DE", "da-DK", "fr-FR")]string culture)
        {
            //Assign
            ...
            try
            {
                Assert.That(result, Is.EqualTo(10000.11f));
            }
            finally
            {
