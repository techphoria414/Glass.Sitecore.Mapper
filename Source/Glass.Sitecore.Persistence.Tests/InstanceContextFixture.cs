...
namespace Glass.Sitecore.Persistence.Tests
{
    ...
    public class InstanceContextFixture
    {
        ...
        {
            //Assign
            InstanceContextFixtureNS.TestClass2 testClass = new Glass.Sitecore.Persistence.Tests.InstanceContextFixtureNS.TestClass2();
        ...
        {
            //Assign
            InstanceContextFixtureNS.TestClass testClass = new Glass.Sitecore.Persistence.Tests.InstanceContextFixtureNS.TestClass();
        ...
        public void SaveClass_WritesClassToSitecoreItem()
        {
            ...
            using (new SecurityDisabler())
            {
                ...
                InstanceContextFixtureNS.TestClass4 testClass = new Glass.Sitecore.Persistence.Tests.InstanceContextFixtureNS.TestClass4();
