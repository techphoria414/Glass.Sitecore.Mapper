...
namespace Glass.Sitecore.Persistence
{
    public class SitecoreService : ISitecoreService
    {
        ...
        public T Create<T>(object parent, string name)  where T: class
        {
            ...
            {
                throw new PersistenceException("Failed to get parent ID", ex);
            }


            if (guid == Guid.Empty) 
                throw new PersistenceException("Guid for parent is empty");
        ...
        public void Delete<T>(T item)  where T: class
        {
            ...
            {
                throw new PersistenceException("Failed to get item ID", ex);
            }

            if (guid == Guid.Empty) 
                throw new PersistenceException("Guid for item is empty");
