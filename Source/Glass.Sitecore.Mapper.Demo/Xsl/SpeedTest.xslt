...
<xsl:template match="*" mode="main">
  ...
  <sc:html field="Body" select="$sc_currentitem" />
  <sc:image  field="Image" select="$sc_currentitem" />
  <xsl:value-of select="sc:path($sc_currentitem)"/>
</xsl:template>
